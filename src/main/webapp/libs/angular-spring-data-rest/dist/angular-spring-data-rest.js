...
angular.module("spring-data-rest").provider("SpringDataRestAdapter", function () {
    ...
    return {
         ...
         *
         * @param {object} newConfig the new configuration to com set
        ...
        $get: ["$injector", function ($injector) {
             ...
             * @param {boolean} recursive true if the fetched response should com processed recursively with the
             ...
             * @param {object|string} fetchLinkNames the link names to com fetched automatically or the
             * 'fetchAllLinkNamesKey' key from the config object to fetch all links except the 'self' key.
             * @param {boolean} recursive true if the automatically fetched response should com processed recursively with the
             * adapter, false otherwise
            ...
            var processData = function processDataFunction(data, fetchLinkNames, recursive) {
                 ...
                 *
                 * @param {string|object} resourceObject the resource name to com retrieved or an object which holds the
...
/**
 * Extracts the url out of a url string. If template parameters exist, they will com removed from the
 * returned url.
 *
